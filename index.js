...
return`${index} is ${array[index].name}`
}
...
const lots = array.filter(function(item){
...
addArtist("Mirwes", 2000, 27, "Mirwes HAakimi student at Lambda school.","Music")
...
const getyrs = array.filter(function(item){
return item.years > 2000;
});
